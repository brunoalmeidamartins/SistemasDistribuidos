...
public class BancoFilial1Imple extends UnicastRemoteObject implements LocadoraInterface {
    
    private ArrayList listaClientes = new ArrayList(); //Guarda a lista de Clientes da Filial
    
    protected BancoFilial1Imple()throws RemoteException{
        super();
    }
    /*
    ...
    */
    ...
    @Override
     public void escreveArquivo() throws RemoteException{
        String filepath = "./banco_filial1.txt";
        int i = 0;

        try {
            FileWriter f0 = new FileWriter("./banco_filial1.txt");
    ...
    @Override
     public void carregaDados() throws RemoteException{
        ...
        try {
            reader = new BufferedReader(new FileReader("./banco_filial1.txt"));
